			...
			<div class="container pb-9">
				...
				<div class="row gap-y align-items-center py-5" id="wallet">
					...
					<div class="col-md-6">
						...
						<p class="regular">Il Client di Scrypta ti permette di avere il controllo della  valuta digitale <strong>Lyra</strong> in completa sicurezza. Raccomandiamo l'uso del Wallet ufficiale che ha funzioni di memorizzazione per le chiavi private dei tuoi indirizzi. Il <strong>Lyra Wallet</strong> è come il tuo conto bancario, quindi prendi precauzioni aggiuntive con le tue password e assicurati di eseguire backup regolari. Scarica il Client adatto al tuo sistema operativo:</p>
				...
				<div class="row gap-y">
					...
					<div class="col-md-12">
						<div class="rounded bg-1 shadow-box image-background contain off-left-background p-4 pl-6 pl-md-9" style="background-image: url(img/shps/payments/get.svg)">
							...
							<p class="color-2 mb-0">L’ architettura di Scrypta può cambiare radicalmente il sistema di relazioni tra i
                                    cittadini e la PA in ragione di una logica decentralizzata e distribuita, che porta a
                                    una maggiore trasparenza, a una maggiore sicurezza e accessibilità.</p>
						</div>
					</div>
				</div>
			</div>

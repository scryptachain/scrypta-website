					...
					<div class="row gap-y text-center text-md-left">
						...
						<div class="col-md-2">
							...
							<nav class="nav flex-column">
								...
								<a class="nav-item py-2" href="https://explorer.scryptachain.org"target="_blank">Block Explorer</a>
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse ml-auto" id="main-navbar">
							<ul class="nav navbar-nav">
								...
								<li class="nav-item">
									<a class="nav-link" target="_blank" href="https://explorer.scryptachain.org">Explorer</a>
								</li>
								<li class="nav-item">
